    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-default-600">
          Configure a integração com o Trello para sincronizar seus projetos automaticamente
        </p>
      </div>
        ...
        <Card className="liquid-glass">
          <CardHeader className="flex gap-3">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-small text-default-500">Acesse o painel de desenvolvedor do Trello</p>
            </div>
          </CardHeader>
          <CardBody>
            <ol className="space-y-2 text-sm text-default-600 mb-4">
              <li>1. Acesse <strong>trello.com/app-key</strong></li>
              <li>2. Copie sua <strong>API Key</strong></li>
              <li>3. Clique em "Token" para gerar um token</li>
              <li>4. Autorize o acesso à sua conta</li>
              <li>5. Copie o <strong>Token</strong> gerado</li>
            </ol>
            <Button
              color="primary"
              variant="flat"
        ...
        <Card className="liquid-glass">
          <CardHeader className="flex gap-3">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-small text-default-500">Crie o arquivo .env.local</p>
            </div>
          </CardHeader>
          <CardBody>
            <p className="text-sm text-default-600 mb-4">
              Crie um arquivo <code className="bg-default-100 px-1 rounded">.env.local</code> na raiz do projeto com:
            </p>
            <div className="bg-default-100 dark:bg-default-800 p-3 rounded-lg text-sm font-mono mb-4">
              <div className="flex justify-between items-center mb-2">
                <span className="text-default-500"># Configuração do Trello</span>
                <Button
                  size="sm"
                  isIconOnly
                  variant="light"
              ...
              <div className="space-y-1">
                <div>NEXT_PUBLIC_TRELLO_API_KEY=<span className="text-warning">sua_api_key_aqui</span></div>
                <div>NEXT_PUBLIC_TRELLO_API_TOKEN=<span className="text-warning">seu_token_aqui</span></div>
                <div>NEXT_PUBLIC_TRELLO_BOARD_ID=<span className="text-success">6807e4880c33aea54daabd5c</span></div>
              </div>
            </div>
      ...
      <Card className="liquid-glass mt-6">
        ...
        <CardBody>
          <div className="grid gap-4 md:grid-cols-2">
            <div>
              <p className="text-sm font-medium text-default-700 mb-1">Board URL:</p>
              <p className="text-xs text-default-500 break-all">
                https://trello.com/invite/b/6807e4880c33aea54daabd5c/...
              </p>
            </div>
            <div>
              <p className="text-sm font-medium text-default-700 mb-1">Board ID:</p>
              <div className="flex items-center gap-2">
                <code className="text-xs bg-default-100 px-2 py-1 rounded">6807e4880c33aea54daabd5c</code>
                <Button
                  size="sm"
                  isIconOnly
                  variant="light"
                  onClick={() => copyToClipboard('6807e4880c33aea54daabd5c', 'Board ID')}
                >
